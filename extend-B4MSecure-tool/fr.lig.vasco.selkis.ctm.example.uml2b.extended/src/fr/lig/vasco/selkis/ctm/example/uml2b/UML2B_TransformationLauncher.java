...
public class UML2B_TransformationLauncher {
...
//		subPackage="Selkis_VASCO_ORBAC::Selkis_VASCO_ORBAC";
		...
		String umlModelName="VideoClub";
//		String umlModelName="UML_ClassDiagram";
//		String umlModelName="sample";
//		String umlModelName="AC";
//		String umlModelName="Selkis_VASCO_ORBAC";
		

		String umlFile="UML/"+umlModelName+".uml";
		String bFile="B/"+umlModelName+".b";
		String traceFile="trace/"+umlModelName+".trace";
			...
			if (subPackage!=null && subPackage!=""){
				...
				if(!neCollection.isEmpty()){
					...
					if (pkgColl.iterator().hasNext()){
						...
						bFile="B/"+pkg.getQualifiedName().replace(':','_')+".b";
					}			
				}
			}
