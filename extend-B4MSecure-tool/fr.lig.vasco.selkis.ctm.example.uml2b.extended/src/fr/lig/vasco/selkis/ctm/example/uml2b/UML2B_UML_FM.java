...
public class UML2B_UML_FM {
		...
		public static void main(String[] args) {
			...
			String umlModelName="UML_FM";
			subPackage="UML_FM::UML_FM_Functional";
			

			String resourcesPath="C:/DevTools/Topcased-3.4.1/WS/fr.lig.vasco.selkis.security.SecureBmodelGenerator/resources/UML_FM/";
