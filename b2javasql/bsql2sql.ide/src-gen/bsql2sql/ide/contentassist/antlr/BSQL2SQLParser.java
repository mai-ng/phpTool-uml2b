 ...
 */
package bsql2sql.ide.contentassist.antlr;

import bsql2sql.ide.contentassist.antlr.internal.InternalBSQL2SQLParser;
...
public class BSQL2SQLParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalBSQL2SQLParser createParser() {
		InternalBSQL2SQLParser result = new InternalBSQL2SQLParser(null);
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalBSQL2SQLParser typedParser = (InternalBSQL2SQLParser) parser;
			typedParser.entryRuleBSQL2SQL();
