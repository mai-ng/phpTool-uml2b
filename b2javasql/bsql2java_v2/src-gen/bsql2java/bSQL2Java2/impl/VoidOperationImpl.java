 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2java.bSQL2Java2.impl.VoidOperationImpl#getOp_name <em>Op name</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.VoidOperationImpl#getPList <em>PList</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.VoidOperationImpl#getPTyping <em>PTyping</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.VoidOperationImpl#getSubs <em>Subs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VoidOperationImpl extends MinimalEObjectImpl.Container implements VoidOperation
{
  ...
  {
    return BSQL2Java2Package.Literals.VOID_OPERATION;
  }
  ...
  public void setOp_name(String newOp_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.VOID_OPERATION__OP_NAME, oldOp_name, op_name));
  }
  ...
  public EList<String> getPList()
  {
    if (pList == null)
    {
      pList = new EDataTypeEList<String>(String.class, this, BSQL2Java2Package.VOID_OPERATION__PLIST);
    }
    return pList;
  }
  ...
  public EList<BParameterTyping> getPTyping()
  {
    if (pTyping == null)
    {
      pTyping = new EObjectContainmentEList<BParameterTyping>(BParameterTyping.class, this, BSQL2Java2Package.VOID_OPERATION__PTYPING);
    }
    return pTyping;
  }
  ...
  public EList<BSubstitution> getSubs()
  {
    if (subs == null)
    {
      subs = new EObjectContainmentEList<BSubstitution>(BSubstitution.class, this, BSQL2Java2Package.VOID_OPERATION__SUBS);
    }
    return subs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQL2Java2Package.VOID_OPERATION__PTYPING:
        return ((InternalEList<?>)getPTyping()).basicRemove(otherEnd, msgs);
      case BSQL2Java2Package.VOID_OPERATION__SUBS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQL2Java2Package.VOID_OPERATION__OP_NAME:
        return getOp_name();
      case BSQL2Java2Package.VOID_OPERATION__PLIST:
        return getPList();
      case BSQL2Java2Package.VOID_OPERATION__PTYPING:
        return getPTyping();
      case BSQL2Java2Package.VOID_OPERATION__SUBS:
