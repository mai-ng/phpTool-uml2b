 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2java.bSQL2Java2.impl.StringOperationImpl#getRes <em>Res</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.StringOperationImpl#getOp_name <em>Op name</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.StringOperationImpl#getPList <em>PList</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.StringOperationImpl#getPTyping <em>PTyping</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.StringOperationImpl#getAnyblock <em>Anyblock</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringOperationImpl extends MinimalEObjectImpl.Container implements StringOperation
{
  ...
  {
    return BSQL2Java2Package.Literals.STRING_OPERATION;
  }
  ...
  public void setRes(String newRes)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.STRING_OPERATION__RES, oldRes, res));
  }
  ...
  public void setOp_name(String newOp_name)
  {
    ...
    op_name = newOp_name;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.STRING_OPERATION__OP_NAME, oldOp_name, op_name));
  }
  ...
  public EList<String> getPList()
  {
    if (pList == null)
    {
      pList = new EDataTypeEList<String>(String.class, this, BSQL2Java2Package.STRING_OPERATION__PLIST);
    }
    return pList;
  }
  ...
  public EList<BParameterTyping> getPTyping()
  {
    if (pTyping == null)
    {
      pTyping = new EObjectContainmentEList<BParameterTyping>(BParameterTyping.class, this, BSQL2Java2Package.STRING_OPERATION__PTYPING);
    }
    return pTyping;
  }
  ...
  public NotificationChain basicSetAnyblock(BAnyBlock newAnyblock, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.STRING_OPERATION__ANYBLOCK, oldAnyblock, newAnyblock);
  ...
  public void setAnyblock(BAnyBlock newAnyblock)
  {
    if (newAnyblock != anyblock)
    {
      ...
      if (anyblock != null)
        msgs = ((InternalEObject)anyblock).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BSQL2Java2Package.STRING_OPERATION__ANYBLOCK, null, msgs);
      if (newAnyblock != null)
        msgs = ((InternalEObject)newAnyblock).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BSQL2Java2Package.STRING_OPERATION__ANYBLOCK, null, msgs);
      msgs = basicSetAnyblock(newAnyblock, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.STRING_OPERATION__ANYBLOCK, newAnyblock, newAnyblock));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQL2Java2Package.STRING_OPERATION__PTYPING:
        return ((InternalEList<?>)getPTyping()).basicRemove(otherEnd, msgs);
      case BSQL2Java2Package.STRING_OPERATION__ANYBLOCK:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQL2Java2Package.STRING_OPERATION__RES:
        return getRes();
      case BSQL2Java2Package.STRING_OPERATION__OP_NAME:
        return getOp_name();
      case BSQL2Java2Package.STRING_OPERATION__PLIST:
        return getPList();
      case BSQL2Java2Package.STRING_OPERATION__PTYPING:
        return getPTyping();
      case BSQL2Java2Package.STRING_OPERATION__ANYBLOCK:
