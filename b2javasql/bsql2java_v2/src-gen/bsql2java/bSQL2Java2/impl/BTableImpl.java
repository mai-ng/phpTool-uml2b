 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2java.bSQL2Java2.impl.BTableImpl#getTable_name <em>Table name</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.BTableImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BTableImpl extends MinimalEObjectImpl.Container implements BTable
{
  ...
  {
    return BSQL2Java2Package.Literals.BTABLE;
  }
  ...
  public void setTable_name(String newTable_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.BTABLE__TABLE_NAME, oldTable_name, table_name));
  }
  ...
  public EList<Attribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, BSQL2Java2Package.BTABLE__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQL2Java2Package.BTABLE__ATTRIBUTES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQL2Java2Package.BTABLE__TABLE_NAME:
