 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2java.bSQL2Java2.impl.BSQLMachineImpl#getM_name <em>Mname</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.BSQLMachineImpl#getSeename <em>Seename</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.BSQLMachineImpl#getVars <em>Vars</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.BSQLMachineImpl#getInv <em>Inv</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.BSQLMachineImpl#getInit <em>Init</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java2.impl.BSQLMachineImpl#getBops <em>Bops</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BSQLMachineImpl extends BSQL2Java2Impl implements BSQLMachine
{
  /**
  ...
  {
    return BSQL2Java2Package.Literals.BSQL_MACHINE;
  }
  ...
  public void setM_name(String newM_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.BSQL_MACHINE__MNAME, oldM_name, m_name));
  }
  ...
  public EList<String> getSeename()
  {
    if (seename == null)
    {
      seename = new EDataTypeEList<String>(String.class, this, BSQL2Java2Package.BSQL_MACHINE__SEENAME);
    }
    return seename;
  }
  ...
  public void setVars(String newVars)
  {
    ...
    vars = newVars;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.BSQL_MACHINE__VARS, oldVars, vars));
  }
  ...
  public NotificationChain basicSetInv(BTable newInv, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.BSQL_MACHINE__INV, oldInv, newInv);
  ...
  public void setInv(BTable newInv)
  {
    if (newInv != inv)
    {
      ...
      if (inv != null)
        msgs = ((InternalEObject)inv).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BSQL2Java2Package.BSQL_MACHINE__INV, null, msgs);
      if (newInv != null)
        msgs = ((InternalEObject)newInv).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BSQL2Java2Package.BSQL_MACHINE__INV, null, msgs);
      msgs = basicSetInv(newInv, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.BSQL_MACHINE__INV, newInv, newInv));
  }
  ...
  public void setInit(String newInit)
  {
    ...
    init = newInit;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2Java2Package.BSQL_MACHINE__INIT, oldInit, init));
  }
  ...
  public EList<BOperation> getBops()
  {
    if (bops == null)
    {
      bops = new EObjectContainmentEList<BOperation>(BOperation.class, this, BSQL2Java2Package.BSQL_MACHINE__BOPS);
    }
    return bops;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQL2Java2Package.BSQL_MACHINE__INV:
        return basicSetInv(null, msgs);
      case BSQL2Java2Package.BSQL_MACHINE__BOPS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQL2Java2Package.BSQL_MACHINE__MNAME:
        return getM_name();
      case BSQL2Java2Package.BSQL_MACHINE__SEENAME:
        return getSeename();
      case BSQL2Java2Package.BSQL_MACHINE__VARS:
        return getVars();
      case BSQL2Java2Package.BSQL_MACHINE__INV:
        return getInv();
      case BSQL2Java2Package.BSQL_MACHINE__INIT:
        return getInit();
      case BSQL2Java2Package.BSQL_MACHINE__BOPS:
        return getBops();
    }
