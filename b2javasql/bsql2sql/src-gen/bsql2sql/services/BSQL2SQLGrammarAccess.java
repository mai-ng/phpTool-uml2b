...
@Singleton
public class BSQL2SQLGrammarAccess extends AbstractGrammarElementFinder {
	
	public class BSQL2SQLElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BSQL2SQL");
	...
	public class BSQLMachineElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BSQLMachine");
	...
	public class BTableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BTable");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.Attribute");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BType");
	...
	public class BValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BValue");
	...
	public class BSOperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BSOperation");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class BoolOperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BoolOperation");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VoidOperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.VoidOperation");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BPredicateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BPredicate");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SQLCallElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.SQLCall");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TableInstanceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.TableInstance");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TIAssignmentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.TIAssignment");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BParameterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BParameter");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BSubstitutionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.BSubstitution");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final BSQL2SQLElements pBSQL2SQL;
	...
	@Inject
	public BSQL2SQLGrammarAccess(GrammarProvider grammarProvider,
			TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pBSQL2SQL = new BSQL2SQLElements();
		this.tSTRING = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "bsql2sql.BSQL2SQL.STRING");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("bsql2sql.BSQL2SQL".equals(grammar.getName())) {
				return grammar;
			}
	...
	//BSQL2SQL:
	//	BSQLMachine;
	public BSQL2SQLElements getBSQL2SQLAccess() {
		return pBSQL2SQL;
	}
	
	public ParserRule getBSQL2SQLRule() {
		return getBSQL2SQLAccess().getRule();
	}
