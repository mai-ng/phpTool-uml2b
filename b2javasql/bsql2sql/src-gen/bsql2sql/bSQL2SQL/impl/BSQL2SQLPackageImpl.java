...
import bsql2sql.bSQL2SQL.BSQL2SQLFactory;
 ...
 * @generated
 */
public class BSQL2SQLPackageImpl extends EPackageImpl implements BSQL2SQLPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private EClass bsql2SQLEClass = null;
   ...
   * @see bsql2sql.bSQL2SQL.BSQL2SQLPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private BSQL2SQLPackageImpl()
  {
    super(eNS_URI, BSQL2SQLFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link BSQL2SQLPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static BSQL2SQLPackage init()
  {
    if (isInited) return (BSQL2SQLPackage)EPackage.Registry.INSTANCE.getEPackage(BSQL2SQLPackage.eNS_URI);

    // Obtain or create and register package
    BSQL2SQLPackageImpl theBSQL2SQLPackage = (BSQL2SQLPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BSQL2SQLPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BSQL2SQLPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theBSQL2SQLPackage.createPackageContents();

    // Initialize created meta-data
    theBSQL2SQLPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theBSQL2SQLPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(BSQL2SQLPackage.eNS_URI, theBSQL2SQLPackage);
    return theBSQL2SQLPackage;
  }
   ...
   * @generated
   */
  public EClass getBSQL2SQL()
  {
    return bsql2SQLEClass;
  }
   ...
   * @generated
   */
  public BSQL2SQLFactory getBSQL2SQLFactory()
  {
    return (BSQL2SQLFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    bsql2SQLEClass = createEClass(BSQL2SQL);
  ...
  public void initializePackageContents()
  {
    ...
    bsqlMachineEClass.getESuperTypes().add(this.getBSQL2SQL());

    // Initialize classes and features; add operations and parameters
    initEClass(bsql2SQLEClass, bsql2sql.bSQL2SQL.BSQL2SQL.class, "BSQL2SQL", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
