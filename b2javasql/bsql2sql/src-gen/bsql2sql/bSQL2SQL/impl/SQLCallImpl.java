 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2sql.bSQL2SQL.impl.SQLCallImpl#getSLeft <em>SLeft</em>}</li>
 *   <li>{@link bsql2sql.bSQL2SQL.impl.SQLCallImpl#getSRight <em>SRight</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SQLCallImpl extends MinimalEObjectImpl.Container implements SQLCall
{
  ...
  {
    return BSQL2SQLPackage.Literals.SQL_CALL;
  }
  ...
  public void setSLeft(String newSLeft)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2SQLPackage.SQL_CALL__SLEFT, oldSLeft, sLeft));
  }
  ...
  public void setSRight(String newSRight)
  {
    ...
    sRight = newSRight;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2SQLPackage.SQL_CALL__SRIGHT, oldSRight, sRight));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQL2SQLPackage.SQL_CALL__SLEFT:
        return getSLeft();
      case BSQL2SQLPackage.SQL_CALL__SRIGHT:
        return getSRight();
    }
