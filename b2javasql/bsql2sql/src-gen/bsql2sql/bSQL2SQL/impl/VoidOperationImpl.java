 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2sql.bSQL2SQL.impl.VoidOperationImpl#getOp_name <em>Op name</em>}</li>
 *   <li>{@link bsql2sql.bSQL2SQL.impl.VoidOperationImpl#getPList <em>PList</em>}</li>
 *   <li>{@link bsql2sql.bSQL2SQL.impl.VoidOperationImpl#getParams <em>Params</em>}</li>
 *   <li>{@link bsql2sql.bSQL2SQL.impl.VoidOperationImpl#getSubs <em>Subs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VoidOperationImpl extends MinimalEObjectImpl.Container implements VoidOperation
{
  ...
  {
    return BSQL2SQLPackage.Literals.VOID_OPERATION;
  }
  ...
  public void setOp_name(String newOp_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2SQLPackage.VOID_OPERATION__OP_NAME, oldOp_name, op_name));
  }
  ...
  public EList<String> getPList()
  {
    if (pList == null)
    {
      pList = new EDataTypeEList<String>(String.class, this, BSQL2SQLPackage.VOID_OPERATION__PLIST);
    }
    return pList;
  }
  ...
  public EList<BParameter> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<BParameter>(BParameter.class, this, BSQL2SQLPackage.VOID_OPERATION__PARAMS);
    }
    return params;
  }
  ...
  public EList<BSubstitution> getSubs()
  {
    if (subs == null)
    {
      subs = new EObjectContainmentEList<BSubstitution>(BSubstitution.class, this, BSQL2SQLPackage.VOID_OPERATION__SUBS);
    }
    return subs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQL2SQLPackage.VOID_OPERATION__PARAMS:
        return ((InternalEList<?>)getParams()).basicRemove(otherEnd, msgs);
      case BSQL2SQLPackage.VOID_OPERATION__SUBS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQL2SQLPackage.VOID_OPERATION__OP_NAME:
        return getOp_name();
      case BSQL2SQLPackage.VOID_OPERATION__PLIST:
        return getPList();
      case BSQL2SQLPackage.VOID_OPERATION__PARAMS:
        return getParams();
      case BSQL2SQLPackage.VOID_OPERATION__SUBS:
