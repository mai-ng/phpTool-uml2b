 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2java.bSQL2Java.impl.BSQLMachineImpl#getM_name <em>Mname</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.impl.BSQLMachineImpl#getVars <em>Vars</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.impl.BSQLMachineImpl#getInv <em>Inv</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.impl.BSQLMachineImpl#getInit <em>Init</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.impl.BSQLMachineImpl#getOps <em>Ops</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BSQLMachineImpl extends BSQL2JavaImpl implements BSQLMachine
{
  /**
   ...
   * @ordered
   */
  protected EList<BSOperation> ops;
  ...
  {
    return BSQL2JavaPackage.Literals.BSQL_MACHINE;
  }
  ...
  public void setM_name(String newM_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BSQL_MACHINE__MNAME, oldM_name, m_name));
  }
  ...
  public void setVars(String newVars)
  {
    ...
    vars = newVars;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BSQL_MACHINE__VARS, oldVars, vars));
  }
  ...
  public NotificationChain basicSetInv(BTable newInv, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BSQL_MACHINE__INV, oldInv, newInv);
  ...
  public void setInv(BTable newInv)
  {
    if (newInv != inv)
    {
      ...
      if (inv != null)
        msgs = ((InternalEObject)inv).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BSQL2JavaPackage.BSQL_MACHINE__INV, null, msgs);
      if (newInv != null)
        msgs = ((InternalEObject)newInv).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BSQL2JavaPackage.BSQL_MACHINE__INV, null, msgs);
      msgs = basicSetInv(newInv, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BSQL_MACHINE__INV, newInv, newInv));
  }
  ...
  public void setInit(String newInit)
  {
    ...
    init = newInit;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BSQL_MACHINE__INIT, oldInit, init));
  }
   ...
   * @generated
   */
  public EList<BSOperation> getOps()
  {
    if (ops == null)
    {
      ops = new EObjectContainmentEList<BSOperation>(BSOperation.class, this, BSQL2JavaPackage.BSQL_MACHINE__OPS);
    }
    return ops;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQL2JavaPackage.BSQL_MACHINE__INV:
        return basicSetInv(null, msgs);
      case BSQL2JavaPackage.BSQL_MACHINE__OPS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQL2JavaPackage.BSQL_MACHINE__MNAME:
        return getM_name();
      case BSQL2JavaPackage.BSQL_MACHINE__VARS:
        return getVars();
      case BSQL2JavaPackage.BSQL_MACHINE__INV:
        return getInv();
      case BSQL2JavaPackage.BSQL_MACHINE__INIT:
        return getInit();
      case BSQL2JavaPackage.BSQL_MACHINE__OPS:
        return getOps();
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case BSQL2JavaPackage.BSQL_MACHINE__OPS:
        getOps().clear();
        getOps().addAll((Collection<? extends BSOperation>)newValue);
        return;
    }
