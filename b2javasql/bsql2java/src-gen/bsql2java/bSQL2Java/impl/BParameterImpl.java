 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2java.bSQL2Java.impl.BParameterImpl#getP_name <em>Pname</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.impl.BParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BParameterImpl extends MinimalEObjectImpl.Container implements BParameter
{
  ...
  {
    return BSQL2JavaPackage.Literals.BPARAMETER;
  }
  ...
  public void setP_name(String newP_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BPARAMETER__PNAME, oldP_name, p_name));
  }
  ...
  public NotificationChain basicSetType(BType newType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BPARAMETER__TYPE, oldType, newType);
  ...
  public void setType(BType newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BSQL2JavaPackage.BPARAMETER__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BSQL2JavaPackage.BPARAMETER__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BPARAMETER__TYPE, newType, newType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQL2JavaPackage.BPARAMETER__TYPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQL2JavaPackage.BPARAMETER__PNAME:
        return getP_name();
      case BSQL2JavaPackage.BPARAMETER__TYPE:
        return getType();
    }
