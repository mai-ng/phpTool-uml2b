 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2java.bSQL2Java.impl.BoolOperationImpl#getOp_name <em>Op name</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.impl.BoolOperationImpl#getPList <em>PList</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.impl.BoolOperationImpl#getParams <em>Params</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.impl.BoolOperationImpl#getObjTable <em>Obj Table</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.impl.BoolOperationImpl#getPres <em>Pres</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoolOperationImpl extends MinimalEObjectImpl.Container implements BoolOperation
{
  ...
  {
    return BSQL2JavaPackage.Literals.BOOL_OPERATION;
  }
  ...
  public void setOp_name(String newOp_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BOOL_OPERATION__OP_NAME, oldOp_name, op_name));
  }
  ...
  public EList<String> getPList()
  {
    if (pList == null)
    {
      pList = new EDataTypeEList<String>(String.class, this, BSQL2JavaPackage.BOOL_OPERATION__PLIST);
    }
    return pList;
  }
  ...
  public EList<BParameter> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<BParameter>(BParameter.class, this, BSQL2JavaPackage.BOOL_OPERATION__PARAMS);
    }
    return params;
  }
  ...
  public NotificationChain basicSetObjTable(TableInstance newObjTable, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BOOL_OPERATION__OBJ_TABLE, oldObjTable, newObjTable);
  ...
  public void setObjTable(TableInstance newObjTable)
  {
    if (newObjTable != objTable)
    {
      ...
      if (objTable != null)
        msgs = ((InternalEObject)objTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BSQL2JavaPackage.BOOL_OPERATION__OBJ_TABLE, null, msgs);
      if (newObjTable != null)
        msgs = ((InternalEObject)newObjTable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BSQL2JavaPackage.BOOL_OPERATION__OBJ_TABLE, null, msgs);
      msgs = basicSetObjTable(newObjTable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQL2JavaPackage.BOOL_OPERATION__OBJ_TABLE, newObjTable, newObjTable));
  }
  ...
  public EList<BPredicate> getPres()
  {
    if (pres == null)
    {
      pres = new EObjectContainmentEList<BPredicate>(BPredicate.class, this, BSQL2JavaPackage.BOOL_OPERATION__PRES);
    }
    return pres;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQL2JavaPackage.BOOL_OPERATION__PARAMS:
        return ((InternalEList<?>)getParams()).basicRemove(otherEnd, msgs);
      case BSQL2JavaPackage.BOOL_OPERATION__OBJ_TABLE:
        return basicSetObjTable(null, msgs);
      case BSQL2JavaPackage.BOOL_OPERATION__PRES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQL2JavaPackage.BOOL_OPERATION__OP_NAME:
        return getOp_name();
      case BSQL2JavaPackage.BOOL_OPERATION__PLIST:
        return getPList();
      case BSQL2JavaPackage.BOOL_OPERATION__PARAMS:
        return getParams();
      case BSQL2JavaPackage.BOOL_OPERATION__OBJ_TABLE:
