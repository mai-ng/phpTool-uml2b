 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2java.bSQL2Java.SQLCall#getSLeft <em>SLeft</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.SQLCall#getSRight <em>SRight</em>}</li>
 * </ul>
 *
 * @see bsql2java.bSQL2Java.BSQL2JavaPackage#getSQLCall()
 * @model
 * @generated
 */
public interface SQLCall extends EObject
{
   ...
   * @see #setSLeft(String)
   * @see bsql2java.bSQL2Java.BSQL2JavaPackage#getSQLCall_SLeft()
   * @model
   * @generated
   */
  String getSLeft();
  ...
  /**
   * Sets the value of the '{@link bsql2java.bSQL2Java.SQLCall#getSLeft <em>SLeft</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see bsql2java.bSQL2Java.BSQL2JavaPackage#getSQLCall_SRight()
   * @model
   * @generated
   */
  String getSRight();
  ...
  /**
   * Sets the value of the '{@link bsql2java.bSQL2Java.SQLCall#getSRight <em>SRight</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
