 ...
 * </p>
 * <ul>
 *   <li>{@link bsql2java.bSQL2Java.BSQLMachine#getM_name <em>Mname</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.BSQLMachine#getVars <em>Vars</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.BSQLMachine#getInv <em>Inv</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.BSQLMachine#getInit <em>Init</em>}</li>
 *   <li>{@link bsql2java.bSQL2Java.BSQLMachine#getOps <em>Ops</em>}</li>
 * </ul>
 *
 * @see bsql2java.bSQL2Java.BSQL2JavaPackage#getBSQLMachine()
 * @model
 * @generated
 */
public interface BSQLMachine extends BSQL2Java
{
  /**
   ...
   * @see bsql2java.bSQL2Java.BSQL2JavaPackage#getBSQLMachine_M_name()
   * @model
   * @generated
   */
  String getM_name();
  ...
  /**
   * Sets the value of the '{@link bsql2java.bSQL2Java.BSQLMachine#getM_name <em>Mname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setVars(String)
   * @see bsql2java.bSQL2Java.BSQL2JavaPackage#getBSQLMachine_Vars()
   * @model
   * @generated
   */
  String getVars();
  ...
  /**
   * Sets the value of the '{@link bsql2java.bSQL2Java.BSQLMachine#getVars <em>Vars</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setInv(BTable)
   * @see bsql2java.bSQL2Java.BSQL2JavaPackage#getBSQLMachine_Inv()
  ...
  /**
   * Sets the value of the '{@link bsql2java.bSQL2Java.BSQLMachine#getInv <em>Inv</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setInit(String)
   * @see bsql2java.bSQL2Java.BSQL2JavaPackage#getBSQLMachine_Init()
   * @model
   * @generated
   */
  String getInit();
  ...
  /**
   * Sets the value of the '{@link bsql2java.bSQL2Java.BSQLMachine#getInit <em>Init</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link bsql2java.bSQL2Java.BSOperation}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see bsql2java.bSQL2Java.BSQL2JavaPackage#getBSQLMachine_Ops()
   * @model containment="true"
   * @generated
   */
