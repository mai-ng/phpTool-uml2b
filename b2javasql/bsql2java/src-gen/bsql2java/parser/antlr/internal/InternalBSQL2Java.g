...
// Entry rule entryRuleBSQL2Java
entryRuleBSQL2Java returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBSQL2JavaRule()); }
	iv_ruleBSQL2Java=ruleBSQL2Java
	{ $current=$iv_ruleBSQL2Java.current; }
	EOF;

// Rule BSQL2Java
ruleBSQL2Java returns [EObject current=null]
@init {
	enterRule();
}
@after {
