 ...
 * </p>
 * <ul>
 *   <li>{@link bsqllog2java.bSQLLog2Java.impl.TIAssignmentImpl#getInstance_name <em>Instance name</em>}</li>
 *   <li>{@link bsqllog2java.bSQLLog2Java.impl.TIAssignmentImpl#getInstance_type <em>Instance type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TIAssignmentImpl extends MinimalEObjectImpl.Container implements TIAssignment
{
  ...
  {
    return BSQLLog2JavaPackage.Literals.TI_ASSIGNMENT;
  }
  ...
  public void setInstance_name(String newInstance_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQLLog2JavaPackage.TI_ASSIGNMENT__INSTANCE_NAME, oldInstance_name, instance_name));
  }
  ...
  public void setInstance_type(String newInstance_type)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQLLog2JavaPackage.TI_ASSIGNMENT__INSTANCE_TYPE, oldInstance_type, instance_type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQLLog2JavaPackage.TI_ASSIGNMENT__INSTANCE_NAME:
        return getInstance_name();
      case BSQLLog2JavaPackage.TI_ASSIGNMENT__INSTANCE_TYPE:
