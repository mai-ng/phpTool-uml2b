 ...
 * </p>
 * <ul>
 *   <li>{@link bsqllog2java.bSQLLog2Java.impl.BTableImpl#getTable_name <em>Table name</em>}</li>
 *   <li>{@link bsqllog2java.bSQLLog2Java.impl.BTableImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BTableImpl extends MinimalEObjectImpl.Container implements BTable
{
  ...
  {
    return BSQLLog2JavaPackage.Literals.BTABLE;
  }
  ...
  public void setTable_name(String newTable_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQLLog2JavaPackage.BTABLE__TABLE_NAME, oldTable_name, table_name));
  }
  ...
  public EList<Attribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, BSQLLog2JavaPackage.BTABLE__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQLLog2JavaPackage.BTABLE__ATTRIBUTES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQLLog2JavaPackage.BTABLE__TABLE_NAME:
