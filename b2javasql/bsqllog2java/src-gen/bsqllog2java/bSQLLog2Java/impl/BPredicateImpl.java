 ...
 * </p>
 * <ul>
 *   <li>{@link bsqllog2java.bSQLLog2Java.impl.BPredicateImpl#getPLeft <em>PLeft</em>}</li>
 *   <li>{@link bsqllog2java.bSQLLog2Java.impl.BPredicateImpl#getPRight <em>PRight</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BPredicateImpl extends MinimalEObjectImpl.Container implements BPredicate
{
  ...
  {
    return BSQLLog2JavaPackage.Literals.BPREDICATE;
  }
  ...
  public NotificationChain basicSetPLeft(SQLCall newPLeft, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BSQLLog2JavaPackage.BPREDICATE__PLEFT, oldPLeft, newPLeft);
  ...
  public void setPLeft(SQLCall newPLeft)
  {
    if (newPLeft != pLeft)
    {
      ...
      if (pLeft != null)
        msgs = ((InternalEObject)pLeft).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BSQLLog2JavaPackage.BPREDICATE__PLEFT, null, msgs);
      if (newPLeft != null)
        msgs = ((InternalEObject)newPLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BSQLLog2JavaPackage.BPREDICATE__PLEFT, null, msgs);
      msgs = basicSetPLeft(newPLeft, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQLLog2JavaPackage.BPREDICATE__PLEFT, newPLeft, newPLeft));
  }
  ...
  public void setPRight(String newPRight)
  {
    ...
    pRight = newPRight;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQLLog2JavaPackage.BPREDICATE__PRIGHT, oldPRight, pRight));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQLLog2JavaPackage.BPREDICATE__PLEFT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQLLog2JavaPackage.BPREDICATE__PLEFT:
        return getPLeft();
      case BSQLLog2JavaPackage.BPREDICATE__PRIGHT:
        return getPRight();
    }
