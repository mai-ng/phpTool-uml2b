 ...
 * </p>
 * <ul>
 *   <li>{@link bsqllog2java.bSQLLog2Java.impl.TableInstanceImpl#getTi_name <em>Ti name</em>}</li>
 *   <li>{@link bsqllog2java.bSQLLog2Java.impl.TableInstanceImpl#getTi_type <em>Ti type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableInstanceImpl extends MinimalEObjectImpl.Container implements TableInstance
{
  ...
  {
    return BSQLLog2JavaPackage.Literals.TABLE_INSTANCE;
  }
  ...
  public void setTi_name(String newTi_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQLLog2JavaPackage.TABLE_INSTANCE__TI_NAME, oldTi_name, ti_name));
  }
  ...
  public NotificationChain basicSetTi_type(TIAssignment newTi_type, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BSQLLog2JavaPackage.TABLE_INSTANCE__TI_TYPE, oldTi_type, newTi_type);
  ...
  public void setTi_type(TIAssignment newTi_type)
  {
    if (newTi_type != ti_type)
    {
      ...
      if (ti_type != null)
        msgs = ((InternalEObject)ti_type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BSQLLog2JavaPackage.TABLE_INSTANCE__TI_TYPE, null, msgs);
      if (newTi_type != null)
        msgs = ((InternalEObject)newTi_type).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BSQLLog2JavaPackage.TABLE_INSTANCE__TI_TYPE, null, msgs);
      msgs = basicSetTi_type(newTi_type, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BSQLLog2JavaPackage.TABLE_INSTANCE__TI_TYPE, newTi_type, newTi_type));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BSQLLog2JavaPackage.TABLE_INSTANCE__TI_TYPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BSQLLog2JavaPackage.TABLE_INSTANCE__TI_NAME:
        return getTi_name();
      case BSQLLog2JavaPackage.TABLE_INSTANCE__TI_TYPE:
        return getTi_type();
    }
