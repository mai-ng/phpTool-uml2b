...
// Entry rule entryRuleBSQLLog2Java
entryRuleBSQLLog2Java returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getBSQLLog2JavaRule()); }
	iv_ruleBSQLLog2Java=ruleBSQLLog2Java
	{ $current=$iv_ruleBSQLLog2Java.current; }
	EOF;

// Rule BSQLLog2Java
ruleBSQLLog2Java returns [EObject current=null]
@init {
	enterRule();
}
@after {
