...
public class BSQLLog2JavaGenerator extends AbstractGenerator {
  ...
  public CharSequence compile(final BSQLMachine m) {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("private PreparedStatement stmt;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("stmt = conn.prepareStatement(\"SELECT *\"");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
  ...
  public CharSequence compile(final BSubFalse subf) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("//execution of the statement that checks if the method ");
    _builder.newLine();
    _builder.append("//is already performed or not,");
    _builder.newLine();
    _builder.append("//returns false if it is already executed, true otherwise.");
    _builder.newLine();
  ...
  public CharSequence compile(final BSubTrue subt) {
    ...
    _builder.append("//is already performed or not,");
    _builder.newLine();
    _builder.append("//returns true if it is already executed, false otherwise.");
    _builder.newLine();
    _builder.append("ResultSet ");
