...
// Entry rule entryRuleB2SQL2
entryRuleB2SQL2 returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getB2SQL2Rule()); }
	iv_ruleB2SQL2=ruleB2SQL2
	{ $current=$iv_ruleB2SQL2.current; }
	EOF;

// Rule B2SQL2
ruleB2SQL2 returns [EObject current=null]
@init {
	enterRule();
}
@after {
