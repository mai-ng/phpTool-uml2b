 ...
 * </p>
 * <ul>
 *   <li>{@link b2sql.b2SQL2.impl.BSubTrueImpl#getRes <em>Res</em>}</li>
 *   <li>{@link b2sql.b2SQL2.impl.BSubTrueImpl#getObjTable <em>Obj Table</em>}</li>
 *   <li>{@link b2sql.b2SQL2.impl.BSubTrueImpl#getPres <em>Pres</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BSubTrueImpl extends MinimalEObjectImpl.Container implements BSubTrue
{
  ...
  {
    return B2SQL2Package.Literals.BSUB_TRUE;
  }
  ...
  public void setRes(String newRes)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.BSUB_TRUE__RES, oldRes, res));
  }
  ...
  public NotificationChain basicSetObjTable(TableInstance newObjTable, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, B2SQL2Package.BSUB_TRUE__OBJ_TABLE, oldObjTable, newObjTable);
  ...
  public void setObjTable(TableInstance newObjTable)
  {
    if (newObjTable != objTable)
    {
      ...
      if (objTable != null)
        msgs = ((InternalEObject)objTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - B2SQL2Package.BSUB_TRUE__OBJ_TABLE, null, msgs);
      if (newObjTable != null)
        msgs = ((InternalEObject)newObjTable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - B2SQL2Package.BSUB_TRUE__OBJ_TABLE, null, msgs);
      msgs = basicSetObjTable(newObjTable, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.BSUB_TRUE__OBJ_TABLE, newObjTable, newObjTable));
  }
  ...
  public EList<BPredicate> getPres()
  {
    if (pres == null)
    {
      pres = new EObjectContainmentEList<BPredicate>(BPredicate.class, this, B2SQL2Package.BSUB_TRUE__PRES);
    }
    return pres;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case B2SQL2Package.BSUB_TRUE__OBJ_TABLE:
        return basicSetObjTable(null, msgs);
      case B2SQL2Package.BSUB_TRUE__PRES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case B2SQL2Package.BSUB_TRUE__RES:
        return getRes();
      case B2SQL2Package.BSUB_TRUE__OBJ_TABLE:
        return getObjTable();
      case B2SQL2Package.BSUB_TRUE__PRES:
