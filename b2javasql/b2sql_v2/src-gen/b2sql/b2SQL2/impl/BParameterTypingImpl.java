 ...
 * </p>
 * <ul>
 *   <li>{@link b2sql.b2SQL2.impl.BParameterTypingImpl#getP_name <em>Pname</em>}</li>
 *   <li>{@link b2sql.b2SQL2.impl.BParameterTypingImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BParameterTypingImpl extends MinimalEObjectImpl.Container implements BParameterTyping
{
  ...
  {
    return B2SQL2Package.Literals.BPARAMETER_TYPING;
  }
  ...
  public void setP_name(String newP_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.BPARAMETER_TYPING__PNAME, oldP_name, p_name));
  }
  ...
  public NotificationChain basicSetType(BType newType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, B2SQL2Package.BPARAMETER_TYPING__TYPE, oldType, newType);
  ...
  public void setType(BType newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - B2SQL2Package.BPARAMETER_TYPING__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - B2SQL2Package.BPARAMETER_TYPING__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.BPARAMETER_TYPING__TYPE, newType, newType));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case B2SQL2Package.BPARAMETER_TYPING__TYPE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case B2SQL2Package.BPARAMETER_TYPING__PNAME:
        return getP_name();
      case B2SQL2Package.BPARAMETER_TYPING__TYPE:
        return getType();
    }
