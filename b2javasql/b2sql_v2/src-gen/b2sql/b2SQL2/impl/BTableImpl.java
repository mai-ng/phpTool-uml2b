 ...
 * </p>
 * <ul>
 *   <li>{@link b2sql.b2SQL2.impl.BTableImpl#getTable_name <em>Table name</em>}</li>
 *   <li>{@link b2sql.b2SQL2.impl.BTableImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BTableImpl extends MinimalEObjectImpl.Container implements BTable
{
  ...
  {
    return B2SQL2Package.Literals.BTABLE;
  }
  ...
  public void setTable_name(String newTable_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.BTABLE__TABLE_NAME, oldTable_name, table_name));
  }
  ...
  public EList<Attribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, B2SQL2Package.BTABLE__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case B2SQL2Package.BTABLE__ATTRIBUTES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case B2SQL2Package.BTABLE__TABLE_NAME:
