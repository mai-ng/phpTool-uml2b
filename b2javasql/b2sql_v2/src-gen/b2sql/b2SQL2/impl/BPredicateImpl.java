 ...
 * </p>
 * <ul>
 *   <li>{@link b2sql.b2SQL2.impl.BPredicateImpl#getPLeft <em>PLeft</em>}</li>
 *   <li>{@link b2sql.b2SQL2.impl.BPredicateImpl#getPRight <em>PRight</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BPredicateImpl extends MinimalEObjectImpl.Container implements BPredicate
{
  ...
  {
    return B2SQL2Package.Literals.BPREDICATE;
  }
  ...
  public NotificationChain basicSetPLeft(SQLCall newPLeft, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, B2SQL2Package.BPREDICATE__PLEFT, oldPLeft, newPLeft);
  ...
  public void setPLeft(SQLCall newPLeft)
  {
    if (newPLeft != pLeft)
    {
      ...
      if (pLeft != null)
        msgs = ((InternalEObject)pLeft).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - B2SQL2Package.BPREDICATE__PLEFT, null, msgs);
      if (newPLeft != null)
        msgs = ((InternalEObject)newPLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - B2SQL2Package.BPREDICATE__PLEFT, null, msgs);
      msgs = basicSetPLeft(newPLeft, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.BPREDICATE__PLEFT, newPLeft, newPLeft));
  }
  ...
  public void setPRight(String newPRight)
  {
    ...
    pRight = newPRight;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.BPREDICATE__PRIGHT, oldPRight, pRight));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case B2SQL2Package.BPREDICATE__PLEFT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case B2SQL2Package.BPREDICATE__PLEFT:
        return getPLeft();
      case B2SQL2Package.BPREDICATE__PRIGHT:
        return getPRight();
    }
