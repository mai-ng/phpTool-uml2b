 ...
 * </p>
 * <ul>
 *   <li>{@link b2sql.b2SQL2.impl.SQLCallImpl#getSLeft <em>SLeft</em>}</li>
 *   <li>{@link b2sql.b2SQL2.impl.SQLCallImpl#getSRight <em>SRight</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SQLCallImpl extends MinimalEObjectImpl.Container implements SQLCall
{
  ...
  {
    return B2SQL2Package.Literals.SQL_CALL;
  }
  ...
  public void setSLeft(String newSLeft)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.SQL_CALL__SLEFT, oldSLeft, sLeft));
  }
  ...
  public void setSRight(String newSRight)
  {
    ...
    sRight = newSRight;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.SQL_CALL__SRIGHT, oldSRight, sRight));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case B2SQL2Package.SQL_CALL__SLEFT:
        return getSLeft();
      case B2SQL2Package.SQL_CALL__SRIGHT:
        return getSRight();
    }
