...
import b2sql.b2SQL2.B2SQL2Factory;
 ...
 * @generated
 */
public class B2SQL2PackageImpl extends EPackageImpl implements B2SQL2Package
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private EClass b2SQL2EClass = null;
   ...
   * @see b2sql.b2SQL2.B2SQL2Package#eNS_URI
   * @see #init()
   * @generated
   */
  private B2SQL2PackageImpl()
  {
    super(eNS_URI, B2SQL2Factory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link B2SQL2Package#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static B2SQL2Package init()
  {
    if (isInited) return (B2SQL2Package)EPackage.Registry.INSTANCE.getEPackage(B2SQL2Package.eNS_URI);

    // Obtain or create and register package
    B2SQL2PackageImpl theB2SQL2Package = (B2SQL2PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof B2SQL2PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new B2SQL2PackageImpl());

    isInited = true;

    // Create package meta-data objects
    theB2SQL2Package.createPackageContents();

    // Initialize created meta-data
    theB2SQL2Package.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theB2SQL2Package.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(B2SQL2Package.eNS_URI, theB2SQL2Package);
    return theB2SQL2Package;
  }
   ...
   * @generated
   */
  public B2SQL2Factory getB2SQL2Factory()
  {
    return (B2SQL2Factory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    b2SQL2EClass = createEClass(B2SQL2);
  ...
  public void initializePackageContents()
  {
    ...
    bsqlMachineEClass.getESuperTypes().add(this.getB2SQL2());

    // Initialize classes and features; add operations and parameters
    initEClass(b2SQL2EClass, b2sql.b2SQL2.B2SQL2.class, "B2SQL2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
