 ...
 * </p>
 * <ul>
 *   <li>{@link b2sql.b2SQL2.impl.BTypeImpl#getType_name <em>Type name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BTypeImpl extends MinimalEObjectImpl.Container implements BType
{
  ...
  {
    return B2SQL2Package.Literals.BTYPE;
  }
  ...
  public void setType_name(String newType_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, B2SQL2Package.BTYPE__TYPE_NAME, oldType_name, type_name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case B2SQL2Package.BTYPE__TYPE_NAME:
        return getType_name();
    }
