 ...
 * </p>
 * <ul>
 *   <li>{@link b2sql.b2SQL2.VoidOperation#getOp_name <em>Op name</em>}</li>
 *   <li>{@link b2sql.b2SQL2.VoidOperation#getPList <em>PList</em>}</li>
 *   <li>{@link b2sql.b2SQL2.VoidOperation#getPTyping <em>PTyping</em>}</li>
 *   <li>{@link b2sql.b2SQL2.VoidOperation#getSubs <em>Subs</em>}</li>
 * </ul>
 *
 * @see b2sql.b2SQL2.B2SQL2Package#getVoidOperation()
 * @model
 * @generated
 */
public interface VoidOperation extends EObject
{
   ...
   * @see b2sql.b2SQL2.B2SQL2Package#getVoidOperation_Op_name()
   * @model
   * @generated
   */
  String getOp_name();
  ...
  /**
   * Sets the value of the '{@link b2sql.b2SQL2.VoidOperation#getOp_name <em>Op name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see b2sql.b2SQL2.B2SQL2Package#getVoidOperation_PList()
   * @model unique="false"
   * @generated
   */
   ...
   * @see b2sql.b2SQL2.B2SQL2Package#getVoidOperation_PTyping()
   ...
   * @see b2sql.b2SQL2.B2SQL2Package#getVoidOperation_Subs()
   * @model containment="true"
   * @generated
   */
