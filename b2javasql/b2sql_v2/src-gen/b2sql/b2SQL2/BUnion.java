 ...
 * </p>
 * <ul>
 *   <li>{@link b2sql.b2SQL2.BUnion#getSet <em>Set</em>}</li>
 *   <li>{@link b2sql.b2SQL2.BUnion#getAddedSet <em>Added Set</em>}</li>
 *   <li>{@link b2sql.b2SQL2.BUnion#getAddedE <em>Added E</em>}</li>
 * </ul>
 *
 * @see b2sql.b2SQL2.B2SQL2Package#getBUnion()
 * @model
 * @generated
 */
public interface BUnion extends EObject
{
   ...
   * @see #setSet(BSet)
   * @see b2sql.b2SQL2.B2SQL2Package#getBUnion_Set()
  ...
  /**
   * Sets the value of the '{@link b2sql.b2SQL2.BUnion#getSet <em>Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see b2sql.b2SQL2.B2SQL2Package#getBUnion_AddedSet()
   * @model containment="true"
   * @generated
   */
  BSet getAddedSet();
  ...
  /**
   * Sets the value of the '{@link b2sql.b2SQL2.BUnion#getAddedSet <em>Added Set</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see b2sql.b2SQL2.B2SQL2Package#getBUnion_AddedE()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link b2sql.b2SQL2.BUnion#getAddedE <em>Added E</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
